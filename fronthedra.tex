...
\linhalayout{música}{João Gabriel Fideles\\\hspace*{1.15cm}Enrique Menezes\\\hspace*{1.15cm}Ricardo Zohyo\\\hspace*{1.15cm}Daniel Grajew\\\hspace*{1.15cm}Diogo Maia}
\linha{capa}{\capa}
...
\ifdef{\organizador}{{\small (\textit{textos})\\ {\organizador} } \par}{}\vspace{8.5mm}
\ifdef{\introdutor}{{\small (\textit{música})\\ {\introdutor} } \par}{}\vspace{8.5mm}
...
\vfill
\normalsize
{\hfill\includegraphics[width=8cm]{./logo_proac.pdf}}
