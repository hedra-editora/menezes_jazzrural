...
\linhalayout{música}{João Gabriel Fideles, Enrique Menezes, Ricardo Zohyo,\\ Daniel Grajew e Diogo Maia}
\linhalayout{pesqusia}{Enrique Menezes, Biancamaria Binazzi e Luísa Valentini}
\linha{capa}{\capa}
...
\vfill
\normalsize
{\includegraphics[width=8cm]{./logos.pdf}\\ São Paulo\quad\the\year}
%\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{\logo}\hfill\logoum{}
